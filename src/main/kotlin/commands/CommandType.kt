...
enum class CommandType(
    ...
    DISABLE("Disable Mod", Category.DEPLOY, enableDescription, enableUsage, ::disable),
    ENDORSE("Endorse Mod", Category.EDIT, endorseDescription, endorseUsage, ::endorse),
    ABSTAIN("Abstain from endorsing Mod", Category.EDIT, endorseDescription, endorseUsage, ::abstain),
    ...
    OPEN("Open mod on web", Category.OPEN, openDescription, openUsage, ::open),
    LOCAL("Open local mod folder", Category.OPEN, openDescription, openUsage, ::local),
    GAME_PATH("Open game folder", Category.OPEN, openDescription, openUsage, ::openGamePath, "gamepath"),
    APPDATA_PATH("Open ini path folder", Category.OPEN, openDescription, openUsage, ::openAppDataPath, "appdatapath"),
    INI_PATH("Open ini path folder", Category.OPEN, openDescription, openUsage, ::openIniPath, "inipath"),
    JAR_PATH("Open jar path folder", Category.OPEN, openDescription, openUsage, ::openJarPath, "jarpath"),
    ...
    RENAME("Rename a mod", Category.EDIT, changeHelp, changeDescription, ::moveMod, "mv"),
